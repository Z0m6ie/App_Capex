...
label = Label(x=0.25, y=0.25, text='IRR: {:.1%}' .format(irrval),
              text_font_size='25pt', text_color='teal')
label2 = Label(x=0.25, y=1.0, text='Yearly Sustaining Captial Spend $: {:,}' .format(suscapyear),
               text_font_size='25pt', text_color='teal')
label3 = Label(x=0.25, y=2.25, text='$/bbl: {:,.0f}' .format(capexperbbl),
               text_font_size='25pt', text_color='teal')
label4 = Label(x=0.25, y=2.75, text='CAPEX $: {:,}' .format(et),
               text_font_size='25pt', text_color='teal')
label5 = Label(x=0.25, y=1.75, text='Yearly OPEX Spend $: {:,}' .format(opexyear),
               text_font_size='25pt', text_color='teal')
